...
export const GizaPage = () => {

  return (
    <div className="bg-black flex gap-24 items-center flex-col justify-center mx-auto h-screen px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32">
        ...
        <h1 className="flex align-bottom items flex-row mx-auto max-w-4xl gap-12  font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-9xl">
            <div className="inline-block text-white">
                ...
                {/* <span className="relative">GIZA</span></span> {" "} */}
                </span>
                <img
            ...
            <span className="inline-block text-white text-8xl">{" "} tech</span>
        </h1>

        <div className="relative group cursor-pointer">
            <div
                className=" absolute -inset-1 rounded-full bg-gradient-to-r from-red-600 to-violet-600 blur group-hover:opacity-100 opacity-25 transition-all duration-1000 group-hover:duration-200">
            </div>
            <div
                className="text-white relative px-7 py-6 ring-1 ring-gray-900/5 rounded-full leading-none flex items-top justify-start space-x-6 transition-all duration-1000 group-hover:duration-200">
        ...
        {/* <p className="mx-auto mt-9 max-w-2xl text-lg tracking-tight text-white sm:mt-6">
            <span className="inline-block">Инновации</span>
        ...
        {/* <div className="mt-12 flex flex-col justify-center gap-y-5 sm:mt-10 sm:flex-row sm:gap-y-0 sm:gap-x-6">
            <a className="group inline-flex items-center justify-center rounded-full py-2 px-4 text-sm font-semibold focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 bg-slate-900 text-white hover:bg-slate-700 hover:text-slate-100 active:bg-slate-800 active:text-slate-300 focus-visible:outline-slate-900 animate-fade-in-left"
                ...
                <span className="ml-3">Версия</span>
            </a>
            <div className="relative flex flex-1 flex-col items-stretch sm:flex-none" data-headlessui-state="">
                <button className="group inline-flex ring-1 items-center justify-center rounded-full py-2 px-4 text-sm focus:outline-none ring-slate-200 text-slate-700 hover:text-slate-900 hover:ring-slate-300 active:bg-slate-100 active:text-slate-600 focus-visible:outline-blue-600 focus-visible:ring-slate-300 animate-fade-in-right" id="headlessui-menu-button-:r4:" aria-haspopup="true" aria-expanded="false" data-headlessui-state="" type="button">
                    ...
                    <span className="ml-3">Спортуслуги</span>
                </button>
            </div>
        </div> */}
