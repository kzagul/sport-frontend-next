...
export const AboutBlock: React.FC = () => {
  return (
    <section id="about" className="bg-white dark:bg-gray-900 w-full">
      <div className="flex flex-col gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
